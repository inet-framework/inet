...
| [evidence/standard/](evidence/standard/ipv4/rfc791-checklist.md) | what · procedure · report · decision | `<DOC>-*`, `<PROTO>-F-*` | Which clause of a standard is checkable, how is it checked, and what did the run show? |
