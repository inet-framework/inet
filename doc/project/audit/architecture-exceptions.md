...
[sweep/interfaces.md](report/sweep/interfaces.md). A class named `I<Stem>` holds a body, a data
...
| Every C++ class named `I<Stem>`, 226 of them (AR-ORG-CONTRACT-PURITY, NR-CPP-TYPE) | 2026-09-07 | [sweep/interfaces.md](report/sweep/interfaces.md). The first run of `check-interfaces.sh`. 210 keep the promise; 16 break it — 14 architecture violations (AV-CONTRACT-01…03) and 2 naming violations — and 9 carry a note the gate leaves to a reviewer, one of which (`IRadioSignal`) is the third NV-19. 7 more hits were sanctioned as AS-03 and AS-04 and count as clean. The earlier 2026-09-01 sweep looked only at `static` members; this one reads every line of the body. |
