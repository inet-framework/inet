...
| [RFC8200-REASM-5](../../standard/rfc8200/catalog.md#rfc8200-reasm-5) | superseded by RFC8504-NR-3 (receiver half) | [overlapping-fragments](../../protocol/ipv6/checks/fragmentation.md#overlapping-fragments) | Rfc8200OverlappingFragments.test | **PASS** (the assertion is repaired) |
| [RFC8200-REASM-6](../../standard/rfc8200/catalog.md#rfc8200-reasm-6) | superseded by RFC8504-NR-4 (receiver half) | [atomic-fragment](../../protocol/ipv6/checks/fragmentation.md#atomic-fragment) | Rfc8200AtomicFragment.test | **PASS** (both defects repaired) |
...
| [RFC4443-PTB-2](../../standard/rfc4443/catalog.md#rfc4443-ptb-2) | selected | [packet-too-big-the-mtu-field](../../protocol/ipv6/checks/packet-too-big.md#packet-too-big-the-mtu-field) | Rfc4443PacketTooBigMtu.test | **PASS** (the report carries the next-hop MTU) |
...
| [RFC4443-MPR-2](../../standard/rfc4443/catalog.md#rfc4443-mpr-2) | selected | [unknown-icmpv6-informational-type](../../protocol/ipv6/checks/input-validation.md#unknown-icmpv6-informational-type) | Rfc4443UnknownInformationalType.test | **PASS** (the runtime error is repaired) |
| [RFC4443-MPR-3](../../standard/rfc4443/catalog.md#rfc4443-mpr-3) | selected | [error-for-an-unknown-protocol](../../protocol/ipv6/checks/error-report.md#error-for-an-unknown-protocol) | Rfc4443ErrorForUnknownProtocol.test | **PASS** (the runtime error at the source is repaired) |
...
| [RFC4443-MPR-7](../../standard/rfc4443/catalog.md#rfc4443-mpr-7) | selected | [no-error-for-a-link-layer-multicast](../../protocol/ipv6/checks/error-report.md#no-error-for-a-link-layer-multicast) | Rfc4443NoErrorForLinkMulticast.test | **PASS** (the missing condition is added) |
| [RFC4443-MPR-8](../../standard/rfc4443/catalog.md#rfc4443-mpr-8) | selected | [no-error-for-a-link-layer-broadcast](../../protocol/ipv6/checks/error-report.md#no-error-for-a-link-layer-broadcast) | Rfc4443NoErrorForLinkBroadcast.test | **PASS** (the missing condition is added) |
