...
| [RFC8200-REASM-5](../../standard/rfc8200/catalog.md#rfc8200-reasm-5) | superseded by RFC8504-NR-3 (receiver half) | [overlapping-fragments](../../protocol/ipv6/checks/fragmentation.md#overlapping-fragments) | Rfc8200OverlappingFragments.test | **PASS** (the assertion is repaired, `ab3b1f1ea0`) |
| [RFC8200-REASM-6](../../standard/rfc8200/catalog.md#rfc8200-reasm-6) | superseded by RFC8504-NR-4 (receiver half) | [atomic-fragment](../../protocol/ipv6/checks/fragmentation.md#atomic-fragment) | Rfc8200AtomicFragment.test | **PASS** (both defects repaired, `ab3b1f1ea0`) |
...
| [RFC4443-PTB-2](../../standard/rfc4443/catalog.md#rfc4443-ptb-2) | selected | [packet-too-big-the-mtu-field](../../protocol/ipv6/checks/packet-too-big.md#packet-too-big-the-mtu-field) | Rfc4443PacketTooBigMtu.test | **PASS** (the report carries the next-hop MTU, since 2026-09-14, `84bc80aa8b`) |
...
| [RFC4443-MPR-2](../../standard/rfc4443/catalog.md#rfc4443-mpr-2) | selected | [unknown-icmpv6-informational-type](../../protocol/ipv6/checks/input-validation.md#unknown-icmpv6-informational-type) | Rfc4443UnknownInformationalType.test | **PASS** (the runtime error is repaired, `40c9f04e21`) |
| [RFC4443-MPR-3](../../standard/rfc4443/catalog.md#rfc4443-mpr-3) | selected | [error-for-an-unknown-protocol](../../protocol/ipv6/checks/error-report.md#error-for-an-unknown-protocol) | Rfc4443ErrorForUnknownProtocol.test | **PASS** (the runtime error at the source is repaired, `cbe91d57c5`) |
...
| [RFC4443-MPR-7](../../standard/rfc4443/catalog.md#rfc4443-mpr-7) | selected | [no-error-for-a-link-layer-multicast](../../protocol/ipv6/checks/error-report.md#no-error-for-a-link-layer-multicast) | Rfc4443NoErrorForLinkMulticast.test | **PASS** (the missing condition is added, `37ddbfa7a8`) |
| [RFC4443-MPR-8](../../standard/rfc4443/catalog.md#rfc4443-mpr-8) | selected | [no-error-for-a-link-layer-broadcast](../../protocol/ipv6/checks/error-report.md#no-error-for-a-link-layer-broadcast) | Rfc4443NoErrorForLinkBroadcast.test | **PASS** (the missing condition is added, `37ddbfa7a8`) |
...
| [RFC8504-NR-1](../../standard/rfc8504/catalog.md#rfc8504-nr-1) | covered (implementation: the RFC 8200 rows) | — (every RFC 8200 check) | — | as the RFC 8200 rows: all PASS; the HDR-2, FRAG-4, FRAG-5 gaps are repaired (`84bc80aa8b`) |
...
| [RFC8504-NR-10](../../standard/rfc8504/catalog.md#rfc8504-nr-10) | covered (implementation: the fragmentation and reassembly rows) | — | — | as those rows: no gaps; both receiver-half defects are repaired (`ab3b1f1ea0`) |
...
that ran: 46 PASS, 1 declined should, and 3 `implementation` statements whose verdict is the
verdict of the rows they point to. The 7 rows that failed as a model gap, and both halves of
the 5 mixed rows (a sender half and a receiver half, or a whole-packet case and a fragment
case), are PASS now: RFC8200-HDR-2, FRAG-4, FRAG-5 (`84bc80aa8b`); RFC8200-REASM-5 /
RFC8504-NR-3 receiver half and RFC8200-REASM-6 / RFC8504-NR-4 receiver half (`ab3b1f1ea0`);
RFC4443-PTB-2 (`84bc80aa8b`); RFC4443-MPR-2 (`40c9f04e21`); RFC4443-MPR-3 (`cbe91d57c5`);
RFC4443-MPR-7, MPR-8 (`37ddbfa7a8`). 17 have none: 4 need a module test (the handoffs of a
received report), 5
...
| --- | --- | --- |
| [IPV6-F-HEADER](../../protocol/ipv6/features.md#ipv6-f-header) | RFC8200-HDR-1 PASS, HDR-3 PASS; HDR-2 PASS on a whole packet and PASS since 2026-09-14 on a fragment (`84bc80aa8b`) | **supported** |
...
| [IPV6-F-SOURCE-FRAGMENTATION](../../protocol/ipv6/features.md#ipv6-f-source-fragmentation) | RFC8200-FRAG-2, FRAG-3 PASS; FRAG-4 and FRAG-5 PASS in structure and PASS since 2026-09-14 in payload length (`84bc80aa8b`); RFC8504-NR-3, NR-4, NR-8 sender halves PASS | **supported** |
| [IPV6-F-REASSEMBLY](../../protocol/ipv6/features.md#ipv6-f-reassembly) | RFC8200-REASM-1, REASM-2, MTU-4, REASM-4, REASM-8 PASS; RFC8504-NR-3 receiver half PASS since 2026-09-14 (`ab3b1f1ea0`) | **supported** |
| [IPV6-F-PACKET-TOO-BIG](../../protocol/ipv6/features.md#ipv6-f-packet-too-big) | RFC8200-FRAG-1 PASS, RFC4443-PTB-1 PASS; RFC4443-PTB-2 PASS since 2026-09-14 (`84bc80aa8b`) | **supported** |
...
| [IPV6-F-INPUT-VALIDATION](../../protocol/ipv6/features.md#ipv6-f-input-validation) | RFC8200-CKSUM-1 (discard) PASS, RFC8504-NR-6 PASS; RFC4443-MPR-2 PASS since 2026-09-14 (`40c9f04e21`) | **supported** |
| [IPV6-F-ERROR-SUPPRESSION](../../protocol/ipv6/features.md#ipv6-f-error-suppression) | RFC4443-MPR-4, MPR-6, MPR-9 PASS; MPR-7, MPR-8 PASS since 2026-09-14 (`37ddbfa7a8`) | **supported** |
| [IPV6-F-ERROR-DELIVERY](../../protocol/ipv6/features.md#ipv6-f-error-delivery) | RFC4443-MPR-1, UL-1, UL-2, UL-3: none ran (internal; module tests). The supporting MPR-3 PASSES since 2026-09-14 (`cbe91d57c5`): a report about an unknown protocol no longer stops the node | **untested** |

Eleven features supported, one untested. All eight defects that the level 3 toolset found
are repaired, on 2026-09-14: the fragment payload length and the whole-packet payload length
of HDR-2 (`84bc80aa8b`), the receiver's handling of overlapping fragments and of atomic
fragments (`ab3b1f1ea0`), the unknown informational ICMPv6 type (`40c9f04e21`), the report
about an unknown protocol at its source (`cbe91d57c5`), the two link-layer suppression cases
(`37ddbfa7a8`), and the Packet Too Big MTU field (`84bc80aa8b`). IPV6-F-ERROR-DELIVERY stays
`untested`: its four core checks are internal and need a module test; its supporting check,
RFC4443-MPR-3, now passes.
...
| 3, Edge | **partial** | Three catalogs complete for the in-scope sections; 18 checks with the relay and the one-link mockup; eight model gaps found, four of them stops of the simulation, all repaired since 2026-09-14 (`84bc80aa8b`, `ab3b1f1ea0`, `cbe91d57c5`, `37ddbfa7a8`, `40c9f04e21`); 10 mandatory statements without a check, listed above. |
| 4, Dynamics | not started | the reassembly timer, the rate limit, congestion, path MTU discovery (the MTU field gap that would have blocked it is repaired, `84bc80aa8b`; the mechanism itself is still level 4) |
...
axes: IPV6-F-REASSEMBLY has a `supported` support value, because every core check that ran
passed, while it reaches level 3 only `partial`, because RFC8200-REASM-3 (the reassembly
timer) has no check yet. A `supported` feature is not the same claim as a feature whose
level 3 is reached.
...
| 3 | 2026-09-23 | **3, partial** | Re-run only, no new check. The run record of the last pass named a commit that the landing rebase removed; this row gives the ledger a run on master. | 27 tests, 27 PASS, 0 FAIL (expected), 0 FAIL (unexpected). Eight verdicts changed since pass 2, all FAIL to PASS: RFC8200-HDR-2 (fragments), FRAG-4, FRAG-5 (payload length) (`84bc80aa8b`); RFC8200-REASM-5 / RFC8504-NR-3 receiver half, RFC8200-REASM-6 / RFC8504-NR-4 receiver half (`ab3b1f1ea0`); RFC4443-PTB-2 (`84bc80aa8b`); RFC4443-MPR-2 (`40c9f04e21`); RFC4443-MPR-3 (`cbe91d57c5`); RFC4443-MPR-7, MPR-8 (`37ddbfa7a8`). 11 features supported (up from 5), 1 untested, 0 partial (down from 6) |
