...
retrieved 2026-09-08. The relationship words are the ones of the workflow: `base`,
...
| --- | --- | --- |
| level 3, Edge | RFC 1122, RFC 6864 | the host requirements and the identification rules are where the edge cases and the negative requirements live |
| level 4, Dynamics | the reassembly timer clauses of RFC 791 §3.2 and of RFC 1122 §3.3.2 | a timer is a distribution, not a value |
| level 5, Complete | RFC 2474, RFC 1191, RFC 950, RFC 4884, RFC 6633, RFC 6918 | the options, the type of service byte, and the ICMP messages the catalogs leave out |
...
Sources of the two cached texts. Each one lives in the folder of its own document,
...
| --- | --- | --- |
| RFC 791 | September 1981, Internet Standard, no revision since | [`rfc791/catalog.md`](../../standard/rfc791/catalog.md) |
| RFC 792 | September 1981, Internet Standard, no revision since | [`rfc792/catalog.md`](../../standard/rfc792/catalog.md) |
