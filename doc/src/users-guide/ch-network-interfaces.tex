...
within transmission range will receive the frame correctly, 
and radios that are out of range will not be affected at all. 
Interference modeling (collisions) is optional.
...
\nedtype{TunInterface} is a virtual network interface be used 
