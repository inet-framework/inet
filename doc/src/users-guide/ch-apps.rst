...
.. _usr:sec:apps:tcp-applications:
...
.. _usr:sec:apps:tcpbasicclientapp:
...
.. _usr:sec:apps:tcpgenericserverapp:
...
.. _usr:sec:apps:tcpserverhostapp:
...
.. _usr:sec:apps:udp-applications:
...
.. _usr:sec:apps:udpvideostreamserver:
...
.. _usr:sec:apps:ipv4/ipv6-traffic-generators:
...
:ned:`IIPvXTraffixGenerator` (prototype) sends IP or IPv6 datagrams to
...
.. _usr:sec:apps:the-pingapp-application:
...
Uses :msg:`PingPayload` as payload for the ICMP(v6) Echo Request/Reply
packets.

.. _usr:sec:apps:ethernet-applications:

Ethernet applications
---------------------

The :ned:`inet.applications.ethernet` package contains modules for a
