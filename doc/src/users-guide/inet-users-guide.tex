...
\newcommand{\msgsnippet}[2]{%
    \lstinputlisting[language=msg,caption={#2},linerange=//!#1-//!End,includerangemarker=false,firstnumber=0]{Snippets.msg}}
\newcommand{\nedsnippet}[2]{%
    \lstinputlisting[language=ned,caption={#2},linerange=//!#1-//!End,includerangemarker=false,firstnumber=0]{Snippets.ned}}
\newcommand{\inisnippet}[2]{%
    \lstinputlisting[language=inifile,caption={#2},linerange=\#!#1-\#!End,includerangemarker=false,firstnumber=0]{Snippets.ini}}
