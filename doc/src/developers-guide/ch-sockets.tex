...
and service indications to the appropriate functions in the \cppclass{ICallback}
...
receive \protocol{UDP} datagrams.
...
Here is how to bind to a specific local address and local port to receive
...
\protocol{TCP} connections, and to send and receive data.
...
\cppsnippet{TcpSocketCallbackInterfaceExample}{TCP socket callback interface
example}
...
and receive \protocol{IPv4} datagrams.
...
\cppsnippet{Ipv4SocketCallbackInterfaceExample}{IPv4 socket callback interface
example}
...
and receive \protocol{IPv6} datagrams.
...
\cppsnippet{Ipv6SocketCallbackInterfaceExample}{IPv6 socket callback interface
example}
...
\cppsnippet{L3SocketCallbackInterfaceExample}{L3 socket callback interface
example}
...
receive datagrams using a \protocol{TUN} interface.
...
A \cppclass{TunSocket} must be associated to a \protocol{TUN} interface before
it can be used:
...
As soon as the \cppclass{TunSocket} is associated to a \protocol{TUN} interface,
