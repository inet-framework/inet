...
% FIXME (#467) RoutingTable::invalidateCache() should clear localBroadcastAddresses.
...
The IPv4 \nedtype{NetworkLayer} contains an instance of the IGMP
