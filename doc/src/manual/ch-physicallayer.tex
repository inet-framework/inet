...
The energy consumer models are in the \ttt{src/physicallayer/power/} directory.
...
The process starts in the transmitter radio when a MAC packet arrives from the
