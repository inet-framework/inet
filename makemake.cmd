...
%MAKEMAKE% -f -n -c ipsuiteconfig.vc

cd %root%\Applications && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\Examples && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\Tests && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\Network && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\NetworkInterfaces && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\Nodes && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\PHY && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\Transport && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc
cd %root%\Util && %MAKEMAKE% -f -n -c ..\ipsuiteconfig.vc

cd %root%\Applications\Generic && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Network\IPv4\Core -I..\..\Util
cd %root%\Applications\PingApp && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Network\IPv4\Core -I..\..\Util
cd %root%\Applications\TCPApp && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Network\IPv4\Core -I..\..\Transport\TCPv4 -I..\..\Util
cd %root%\Applications\TCPExample && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\TCPApp -I..\..\Network\IPv4\Core -I..\..\Transport\TCPv4 -I..\..\Network\MPLS -I..\..\Network\LDP -I..\..\Util

cd %root%\Examples\IPSuite && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc
cd %root%\Examples\MPLS && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc
...
cd %root%\Examples\MPLS\Tester && %MAKEMAKE% -f -n -c ..\..\..\ipsuiteconfig.vc %ALL_MPLS_INCLUDES%
...
cd %root%\Examples\MPLS\samples && %MAKEMAKE% -f -n -c ..\..\..\ipsuiteconfig.vc
...
cd %root%\Tests\MPLS && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc
cd %root%\Tests\MPLS\LDP1 && %MAKEMAKE% -f -w -c ..\..\..\ipsuiteconfig.vc %ALL_MPLS_INCLUDES% %LIBXML_LIBS%

cd %root%\Network\IPv4 && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc 
cd %root%\Network\MPLS && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\IPv4\Core -I..\..\Transport\TCPv4 -I..\..\Util
cd %root%\Network\LDP && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\IPv4\Core -I..\..\Transport\TCPv4 -I..\..\Transport\UDPv4 -I..\MPLS -I..\..\Util
cd %root%\Network\RSVP_TE && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\IPv4\Core -I..\..\Transport\TCPv4 -I..\MPLS -I..\..\Util %LIBXML_INCLUDES%
cd %root%\Network\IPv4\Core && %MAKEMAKE% -f -n -c ..\..\..\ipsuiteconfig.vc -I..\QoSStub -I..\..\..\NetworkInterfaces -I..\..\..\NetworkInterfaces\Queues -I..\..\..\Util
cd %root%\Network\IPv4\QoS && %MAKEMAKE% -f -n -c ..\..\..\ipsuiteconfig.vc -I..\QoSStub -I..\Core -I..\..\..\Transport\TCPv4 -I..\..\..\Util
cd %root%\Network\IPv4\QoSStub && %MAKEMAKE% -f -n -c ..\..\..\ipsuiteconfig.vc -I..\Core -I..\..\..\Util

cd %root%\NetworkInterfaces\PPP-old && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Util -I..\..\Network\IPv4\Core
cd %root%\NetworkInterfaces\Queues && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Util -I..\..\Network\IPv4\Core -I..\..\Network\IPv4\QoS

cd %root%\Nodes\IPSuite && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Network\IPv4\Core -I..\..\Network\IPv4\QoS -I..\..\Transport\TCPv4 -I..\..\Transport\UDPv4 -I..\..\NetworkInterfaces\PPP-old -I..\..\NetworkInterfaces -I..\..\NetworkInterfaces\Queues  -I..\..\Applications\Generic -I..\..\Applications\TCPApp -I..\..\Applications\PingApp -I..\..\Util
...
cd %root%\Transport\Socketv4 && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\TCPv4 -I..\..\Network\IPv4\Core -I..\..\Util
cd %root%\Transport\TCPv4 && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\..\Network\IPv4\Core -I..\..\Applications\TCPApp -I..\..\Util
cd %root%\Transport\UDPv4 && %MAKEMAKE% -f -n -c ..\..\ipsuiteconfig.vc -I..\TCPv4 -I..\..\Network\IPv4\Core -I..\..\Util
