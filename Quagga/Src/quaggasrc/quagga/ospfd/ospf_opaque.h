...
extern int ospf_opaque_new_if (struct interface_FOO *ifp);
extern int ospf_opaque_del_if (struct interface_FOO *ifp);
...
extern void ospf_opaque_config_write_if (struct vty *vty, struct interface_FOO *ifp);
