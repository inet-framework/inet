...
for congestionDuration in congestionDurations:
	...
	for reducePacketTimeThreshold in reducePacketTimeThresholds:
		...
		for msgLength in msgLengths:
			measurements[congestionDuration][reducePacketTimeThreshold][msgLength] = [[], [], []]
...
""")
				...
				measurements[congestionDuration][reducePacketTimeThreshold][msgLength][0].append(maxN)
				measurements[congestionDuration][reducePacketTimeThreshold][msgLength][1].append(maxT)
				measurements[congestionDuration][reducePacketTimeThreshold][msgLength][2].append(maxPc)
...
np.save(path + "congestion_fixed", result, allow_pickle=True)
