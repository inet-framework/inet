...
for alg in algs:
	...
	#maxProbesAx.errorbar(plrs, measurements[alg]['maxProbeNumbers'][0], measurements[alg]['maxProbeNumbers'][1], capsize=3.0, linestyle=":", color=colors[alg], label=label)
...
ax.set(xlabel='Packet Loss Rate [\%]', ylabel='Search Time [ms]')
...
fig.savefig("packetloss_time.pdf")
plt.show()