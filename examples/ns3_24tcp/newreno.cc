...
int main(int argc, char *argv[]) {
  ...
  p2p1.SetQueue("ns3::DropTailQueue", "MaxPackets", UintegerValue(10));
  ...
  queue = CreateObjectWithAttributes<DropTailQueue>("MaxPackets", UintegerValue(10));
