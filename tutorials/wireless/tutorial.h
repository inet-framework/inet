...
Host A is transmitting packets generated by its UDP Application module. R1 is in
...
sequence chart illustrates packet traffic between Hosts A's, R1's and C's network layer.
