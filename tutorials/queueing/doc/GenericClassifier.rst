...
The packets are pushed into a :ned:`PacketClassifier` module, which is connected to two passive
packet sinks (:ned:`PassivePacketSink`).

The source generates 1-byte packets that randomly contain either 0 or 1 as data. The classifier
