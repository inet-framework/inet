...
For example, if the configured weights are [2,3], then the first two packets are sent to output 0,
and the next three to output 1. If a component connected to an output is busy (the output is
