...
PAUSE
pause playing, stay at current position
STOP
stop playing, go to beginning
PLAY_UNTIL_TIME
start playing from current position and play until given temporal position (relative to
start of file is reached)
PLAY_UNTIL_BYTE
start playing from current position and play until this data byte is reached
SEEK_TIME
go to temporal position within the file (not allowed while playing)
SEEK_BYTE
