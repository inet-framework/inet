...
/*
*    File Name rsvp_message.h
*    RSVP-TE library
*    This file defines RSVP-TE message hierarchy
**/
...
public:
    ...
    inline void setLabelRequest(LabelRequestObj_t* l)
    {/*label_request.request = l->request;*/ label_request.prot = l->prot;}
    inline LabelRequestObj_t* getLabelRequest(){return &label_request;}

    inline RsvpHopObj_t* getHop(){return &rsvp_hop;}
    inline SenderTemplateObj_t* getSenderTemplate()
    {return &sender_descriptor.Sender_Template_Object;}
    inline SenderTspecObj_t* getSenderTspec()
    {return &sender_descriptor.Sender_Tspec_Object;}
...
public:
    ResvMessage();
    inline FlowDescriptor_t* getFlowDescriptorList(){return
    ...
    inline int getNHOP(){return rsvp_hop.Next_Hop_Address;}
     ...
     inline RsvpHopObj_t* getHop(){return &rsvp_hop;}
     inline FlowDescriptor_t* getFlowDescriptor()
                         {return flow_descriptor_list;}
     inline void setRTime(double t){refresh_time =t;}
