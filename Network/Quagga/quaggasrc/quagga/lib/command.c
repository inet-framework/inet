...
struct_host host_lib;

/* Standard command node structures. */
struct cmd_node auth_node_lib =
{
  AUTH_NODE,
  "Password: ",
};

struct cmd_node view_node_lib =
{
  VIEW_NODE,
  "%s> ",
};

struct cmd_node auth_enable_node_lib =
{
  AUTH_ENABLE_NODE,
  "Password: ",
};

struct cmd_node enable_node_lib =
{
  ENABLE_NODE,
  "%s# ",
};

struct cmd_node config_node_lib =
{
  CONFIG_NODE,
  "%s(config)# ",
  1
