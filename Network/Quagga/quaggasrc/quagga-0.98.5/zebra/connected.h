...
void
connected_up_ipv4 (struct interface_FOO *, struct connected *);
void
connected_down_ipv4 (struct interface_FOO *, struct connected *);
...
void
connected_add_ipv6 (struct interface_FOO *ifp, struct in6_addr *address,
		    int prefixlen, struct in6_addr *broad);
void
connected_delete_ipv6 (struct interface_FOO *ifp, struct in6_addr *address,
		       int prefixlen, struct in6_addr *broad);
void
connected_up_ipv6 (struct interface_FOO *, struct connected *);

void
connected_down_ipv6 (struct interface_FOO *ifp, struct connected *);
