...
void if_delete_update (struct interface_FOO *ifp);
void if_add_update (struct interface_FOO *ifp);
void if_up (struct interface_FOO *);
void if_down (struct interface_FOO *);
void if_refresh (struct interface_FOO *);
...
#ifdef BSDI
int if_kvm_get_mtu (struct interface_FOO *);
#endif /* BSDI */
