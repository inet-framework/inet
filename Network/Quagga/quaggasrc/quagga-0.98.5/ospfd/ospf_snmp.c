...
void
ospf_snmp_if_delete (struct interface_FOO *ifp)
{
  struct listnode *nn;
  struct ospf_snmp_if *osif;
...
void
ospf_snmp_if_update (struct interface_FOO *ifp)
{
  struct listnode *nn;
  struct listnode *pn;
...
int
ospf_snmp_iftype (struct interface_FOO *ifp)
{
