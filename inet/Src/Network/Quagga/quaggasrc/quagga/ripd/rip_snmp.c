...
void
rip_ifaddr_add (struct interface_FOO *ifp, struct connected *ifc)
{
  struct prefix *p;
...
void
rip_ifaddr_delete (struct interface_FOO *ifp, struct connected *ifc)
{
  struct prefix *p;
  struct route_node *rn;
  struct interface_FOO *i;
