...
bgp_adj_out_lookup (struct peer *peer, struct prefix *p,
		    afi_t afi, safi_t safi, struct_bgp_node *rn)
{
...
void
bgp_adj_out_set (struct_bgp_node *rn, struct peer *peer, struct prefix *p,
...
void
bgp_adj_out_unset (struct_bgp_node *rn, struct peer *peer, struct prefix *p, 
		   afi_t afi, safi_t safi)
{
  struct bgp_adj_out *adj;
  struct bgp_advertise *adv;
...
void
bgp_adj_out_remove (struct_bgp_node *rn, struct bgp_adj_out *adj, 
...

void
bgp_adj_in_set (struct_bgp_node *rn, struct peer *peer, struct attr *attr)
{
...
void
bgp_adj_in_remove (struct_bgp_node *rn, struct bgp_adj_in *bai)
{
...
void
bgp_adj_in_unset (struct_bgp_node *rn, struct peer *peer)
{
  struct bgp_adj_in *adj;
