...
void
zebra_interface_up_update (struct interface_FOO *ifp)
{
  struct listnode *node;
  struct zserv *client;
...
void
zebra_interface_down_update (struct interface_FOO *ifp)
{
  struct listnode *node;
  struct zserv *client;
...
void
zebra_interface_add_update (struct interface_FOO *ifp)
{
  struct listnode *node;
  struct zserv *client;
...
void
zebra_interface_delete_update (struct interface_FOO *ifp)
{
  struct listnode *node;
  struct zserv *client;
...
void
zebra_interface_address_add_update (struct interface_FOO *ifp,
...
void
zebra_interface_address_delete_update (struct interface_FOO *ifp,
				       struct connected *ifc)
{
  struct listnode *node;
  struct zserv *client;
