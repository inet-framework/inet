...
struct ospf_opaque_functab
{
  ...
  int (* new_if_hook)(struct interface_FOO *ifp);
  int (* del_if_hook)(struct interface_FOO *ifp);
  ...
  void (* config_write_if    )(struct vty *vty, struct interface_FOO *ifp);
...
static int
opaque_lsa_new_if_callback (struct list *funclist, struct interface_FOO *ifp)
{
  struct listnode *node;
  struct ospf_opaque_functab *functab;
  int rc = -1;
...
static int
opaque_lsa_del_if_callback (struct list *funclist, struct interface_FOO *ifp)
{
  struct listnode *node;
  struct ospf_opaque_functab *functab;
  int rc = -1;
...
opaque_lsa_config_write_if_callback (struct list *funclist,
                                     struct vty *vty, struct interface_FOO *ifp)
{
  struct listnode *node;
  struct ospf_opaque_functab *functab;
...
int
ospf_opaque_new_if (struct interface_FOO *ifp)
{
  struct list *funclist;
  int rc = -1;
...
int
ospf_opaque_del_if (struct interface_FOO *ifp)
{
  struct list *funclist;
  int rc = -1;
...
void
ospf_opaque_config_write_if (struct vty *vty, struct interface_FOO *ifp)
{
  struct list *funclist;
