...
struct route_map_rule_cmd route_match_ip_nexthop_cmd_ospfd =
{
  "ip next-hop",
...
struct route_map_rule_cmd route_match_ip_next_hop_prefix_list_cmd_ospfd =
{
...
struct route_map_rule_cmd route_match_ip_address_cmd_ospfd =
{
  "ip address",
...
struct route_map_rule_cmd route_match_ip_address_prefix_list_cmd_ospfd =
{
...
/* Route map commands for ip address matching. */
struct route_map_rule_cmd route_match_interface_cmd_ospfd =
{
  "interface",
...
struct route_map_rule_cmd route_set_metric_cmd_ospfd =
{
  "metric",
  route_set_metric,
...
/* Set metric rule structure. */
struct route_map_rule_cmd route_set_metric_type_cmd_ospfd =
{
  "metric-type",
