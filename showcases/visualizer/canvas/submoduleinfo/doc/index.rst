...
``inet/showcases/visualizer/canvas/submoduleinfo`` folder in the `Project Explorer`. There, you can view
...
.. code-block:: bash
    ...
    $ opp_env run inet-4.5 --init -w inet-workspace --install --chdir \
       -c 'cd inet-4.5.*/showcases/visualizer/canvas/submoduleinfo && inet'
