...
network between the two ends, and many networks discard ICMP traffic. Deliberate
filtering is the usual cause. Routers also rate-limit the ICMP errors they generate,
