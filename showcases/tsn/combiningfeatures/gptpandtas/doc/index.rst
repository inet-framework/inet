...
``inet/showcases/tsn/combiningfeatures/gptpandtas`` folder in the `Project Explorer`. There, you can view
...
.. code-block:: bash
    ...
    $ opp_env run inet-4.6 --init -w inet-workspace --install --build-modes=release --chdir \
       -c 'cd inet-4.6.*/showcases/tsn/combiningfeatures/gptpandtas && inet'
