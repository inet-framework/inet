...
inet_project = define_simulation_project("inet", version=None,
                                         ...
                                         ned_folders=["src", "examples", "showcases", "tutorials", "tests/networks", "tests/validation", "wfcs2025"],
                                         ned_exclusions=None,
                                         ini_file_folders=["examples", "showcases", "tutorials", "tests/fingerprint", "tests/validation", "wfcs2025"],
