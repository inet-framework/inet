...
class CompareSimulationsTask(Task):
    ...
    def run_protected(self, ingredients="tplx", index=None, append_args=[], **kwargs):
        append_args = append_args + ["--cmdenv-express-mode=false", "--cmdenv-log-prefix=%l %C%<: ", "--cmdenv-redirect-output=true",  "--eventlog-snapshot-frequency=100MiB", "--eventlog-index-frequency=10MiB", "--eventlog-options=custom", "--fingerprint=0000-0000/" + ingredients] + get_ingredients_append_args(ingredients)
