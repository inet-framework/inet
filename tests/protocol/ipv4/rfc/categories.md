...
### ttl-decrement (R791-TTL-1, R791-TTL-3) → protocol test
...
### fragment-reassembly (R791-FRAG-1..4, R791-REASM-1) → protocol test
...
### dont-fragment (R791-FRAG-5, R792-DU-4) → protocol test
...
| --- | --- | --- |
| R791-TTL-2, R792-TE-1 | protocol | wire absence plus an ICMP report |
| R791-FRAG-6 | protocol | wire observation with a 68-octet datagram |
| R791-REASM-2 | protocol | end-to-end delivery of a 576-octet datagram |
| R791-REASM-3 | protocol (injection) | needs crafted or interleaved fragment trains |
| R791-CKSUM-1 | unit + protocol | the algorithm is a serializer concern; the change across a hop is wire-visible |
| R791-CKSUM-2 | protocol (interception) | needs corruption of a datagram in flight |
| R791-ID-1 | protocol | compare the identification of two successive datagrams |

## General rule of thumb

| Observation class (checklist.md) | Usual category |
| --- | --- |
