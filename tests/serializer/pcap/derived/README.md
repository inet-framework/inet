...
# 802.11: drops the 8 VHT/HE NDP Announcement frames (control subtype not modelled) and
# the 1 unsuccessful Reassociation Response with a non-zero AID (rejected by the model)
editcap -F pcap -r wlan-blockack-reassoc.pcap derived/wlan-blockack-reassoc-clean.pcap \
        1-59 61-140 142-167 175-218
