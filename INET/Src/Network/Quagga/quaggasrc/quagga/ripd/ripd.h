...
int rip_request_send (struct sockaddr_in *, struct interface_FOO *, u_char,
                      struct connected *);
...
void rip_distribute_update_interface (struct interface_FOO *);
void rip_if_rmap_update_interface (struct interface_FOO *);
...
int rip_offset_list_apply_in (struct prefix_ipv4 *, struct interface_FOO *, u_int32_t *);
int rip_offset_list_apply_out (struct prefix_ipv4 *, struct interface_FOO *, u_int32_t *);
...
void rip_ifaddr_add (struct interface_FOO *, struct connected *);
void rip_ifaddr_delete (struct interface_FOO *, struct connected *);

/* There is only one rip strucutre. */
extern struct_rip *rip_ripd;

/* Master thread strucutre. */
extern struct thread_master *master_ripd;

/* RIP statistics for SNMP. */
extern long rip_global_route_changes_ripd;
extern long rip_global_queries_ripd;
