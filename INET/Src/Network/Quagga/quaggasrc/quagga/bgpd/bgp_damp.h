...
#ifndef __BGPDAMP_H__
#define __BGPDAMP_H__
...
int bgp_damp_withdraw (struct bgp_info *, struct_bgp_node *,
		       afi_t, safi_t, int);
int bgp_damp_update (struct bgp_info *, struct_bgp_node *, afi_t, safi_t);
