...
struct bgp_damp_config bgp_damp_cfg_bgpd;
struct bgp_damp_config *damp_bgpd ;
...
int
bgp_damp_withdraw (struct bgp_info *binfo, struct_bgp_node *rn,
...
int
bgp_damp_update (struct bgp_info *binfo, struct_bgp_node *rn, 
...
bgp_damp_info_free (struct bgp_damp_info *bdi, int withdraw)
{
  ...
  void bgp_info_delete (struct_bgp_node *, struct bgp_info *);
