...
void Ieee80211MgmtSTA::initialize(int stage)
{
    ...
    if (stage==0)
    {
        ...
        nb = getModuleFromPar<NotificationBoard>(par("NotificationBoardModule"), this);
