...
#include "inet_old/base/NotifierConsts.h"
#include "inet_old/linklayer/radio/Radio.h"
#include "inet_old/linklayer/contract/PhyControlInfo_m.h"
#include "inet_old/linklayer/contract/Radio80211aControlInfo_m.h"
...
void Radio::initialize(int stage)
{
    ...
    if (stage == 0)
    {
        ...
        thermalNoise = math::dBm2mW(par("thermalNoise"));
        sensitivity = math::dBm2mW(par("sensitivity"));
...
void Radio::updateSensitivity(double rate)
{
    ...
    if (rate == 6E+6)
    {
        sensitivity = math::dBm2mW (-82);
    }
    else if (rate == 9E+6)
    {
        sensitivity = math::dBm2mW (-81);
    }
    else if (rate == 12E+6)
    {
        sensitivity = math::dBm2mW (-79);
    }
    else if (rate == 18E+6)
    {
        sensitivity = math::dBm2mW (-77);
    }
    else if (rate == 24E+6)
    {
        sensitivity = math::dBm2mW (-74);
    }
    else if (rate == 36E+6)
    {
        sensitivity = math::dBm2mW (-70);
    }
    else if (rate == 48E+6)
    {
        sensitivity = math::dBm2mW (-66);
    }
    else if (rate == 54E+6)
    {
        sensitivity = math::dBm2mW (-65);
    }
