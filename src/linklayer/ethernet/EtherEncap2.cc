...
// #include "EtherMAC.h"
#include "EtherEncap2.h"


Define_Module(EtherEncap2);

void EtherEncap2::initialize()
{
    seqNum = 0;
    WATCH(seqNum);
...
void EtherEncap2::handleMessage(cMessage *msg)
{
...
void EtherEncap2::updateDisplayString()
{
    char buf[80];
...
void EtherEncap2::processPacketFromHigherLayer(cPacket *msg)
{
...
void EtherEncap2::processFrameFromMAC(EtherFrame *frame)
{
    totalFromMAC++;
...
void EtherEncap2::handleSendPause(cMessage *msg)
{
