...
#include "MACRelayUnitNPWithTC.h"
#include "EtherFrame_m.h"
#include "Ethernet.h"
#include "MACAddress.h"


Define_Module( MACRelayUnitNPWithTC );
...
MACRelayUnitNPWithTC::MACRelayUnitNPWithTC()
{
    endProcEvents = NULL;
    numCPUs = 0;
}
...
void MACRelayUnitNPWithTC::initialize()
{
...
void MACRelayUnitNPWithTC::handleMessage(cMessage *msg)
{
...
void MACRelayUnitNPWithTC::handleIncomingFrame(EtherFrame *frame)
{
...
void MACRelayUnitNPWithTC::processFrame(cMessage *msg)
{
    int cpu = msg->getKind();
...
void MACRelayUnitNPWithTC::finish()
{
