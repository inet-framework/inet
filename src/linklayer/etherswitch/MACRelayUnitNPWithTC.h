...
/**
 * Implementation of MACRelayUnitNP with traffic control before
 * dispatcing frames to output ports.
 */
class INET_API MACRelayUnitNPWithTC : public MACRelayUnitNP
{
  public:
    MACRelayUnitNPWithTC();
    virtual ~MACRelayUnitNPWithTC();
