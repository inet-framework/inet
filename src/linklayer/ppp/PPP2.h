...
#ifndef __INET_PPP2_H
#define __INET_PPP2_H
...
/**
 * PPP2 implementation (PPP without interface registration and notification).
 */
//class INET_API PPP : public cSimpleModule, public INotifiable
class INET_API PPP2 : public cSimpleModule
{
  protected:
    long txQueueLimit;
    cGate *physOutGate;
