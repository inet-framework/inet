...
void PPP2::initialize(int stage)
{
...
//InterfaceEntry *PPP2::registerInterface(double datarate)
//{
...
void PPP2::startTransmitting(cPacket *msg)
{
...
void PPP2::handleMessage(cMessage *msg)
{
...
//void PPP2::receiveChangeNotification(int category, const cPolymorphic *)
//{
//    if (category==NF_SUBSCRIBERLIST_CHANGED)
//        updateHasSubcribers();
//}

PPPFrame *PPP2::encapsulate(cPacket *msg)
{
...
cPacket *PPP2::decapsulate(PPPFrame *pppFrame)
{
