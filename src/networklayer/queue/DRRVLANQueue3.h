...
#ifndef __INET_DRRVLANQUEUE3_H
#define __INET_DRRVLANQUEUE3_H
 ...
 */
class INET_API DRRVLANQueue3 : public DRRVLANQueue
{
protected:
  ...
  protected:
    ...
    // statistics
    DoubleVector numConformedBitsSent;
    DoubleVector numNonconformedBitsSent;
    IntVector numConformedPktsSent;
    IntVector numNonconformedPktsSent;

  public:
    DRRVLANQueue3();
    virtual ~DRRVLANQueue3();
