...
Define_Module(PIControlClock);

void PIControlClock::initialize(int stage)
{
...
simtime_t PIControlClock::handleOverdueClockEvent(ClockEvent *event, simtime_t t)
{
...
void PIControlClock::processCommand(const cXMLElement& node)
{
