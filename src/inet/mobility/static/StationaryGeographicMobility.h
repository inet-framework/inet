...
#ifndef __INET_STATIONARYGEOGRAPHICMOBILITY_H
#define __INET_STATIONARYGEOGRAPHICMOBILITY_H
 ...
 * @ingroup mobility
 */
class INET_API StationaryGeographicMobility : public MobilityBase
{
  protected:
...
#endif // ifndef __INET_STATIONARYGEOGRAPHICMOBILITY_H
