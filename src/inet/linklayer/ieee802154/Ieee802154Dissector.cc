...
#include "inet/linklayer/ieee802154/Ieee802154Dissector.h"
...
Register_Protocol_Dissector(&Protocol::ieee802154, Ieee802154Dissector);

void Ieee802154Dissector::dissect(Packet *packet, ICallback& callback) const
{
