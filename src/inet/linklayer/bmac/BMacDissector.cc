...
#include "inet/linklayer/bmac/BMacDissector.h"
...
Register_Protocol_Dissector(&Protocol::bmac, BMacDissector);

void BMacDissector::dissect(Packet *packet, ICallback& callback) const
{
