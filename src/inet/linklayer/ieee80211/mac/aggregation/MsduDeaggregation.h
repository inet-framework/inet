...
{
    protected:
        virtual void setExplodedFrameAddress(const Ptr<Ieee80211DataHeader>& frame, const Ptr<Ieee80211MsduSubframe>& subframe, const Ptr<Ieee80211DataHeader>& aMsduFrame);
