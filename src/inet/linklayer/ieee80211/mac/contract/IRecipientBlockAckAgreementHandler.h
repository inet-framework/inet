...
class INET_API IRecipientBlockAckAgreementHandler
{
    public:
        ...
        virtual void processTransmittedAddbaResp(const Ptr<Ieee80211AddbaResponse>& addbaResp, IBlockAckAgreementHandlerCallback *callback) = 0;
        ...
        virtual void qosFrameReceived(const Ptr<Ieee80211DataFrame>& qosFrame, IBlockAckAgreementHandlerCallback *callback) = 0;
