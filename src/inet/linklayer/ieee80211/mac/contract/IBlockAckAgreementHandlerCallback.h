...
class INET_API IBlockAckAgreementHandlerCallback
{
  public:
    ...
    virtual bool releaseBlockAckAgreementFrames(MacAddress peerAddress, Tid tid) = 0;
    ...
    virtual void cancelBlockAckTeardown(bool initiator, MacAddress peerAddress, Tid tid, uint64_t generationId, Packet *excludedPacket) = 0;
};
