...
IFrameSequenceStep *DataFs::prepareStep(FrameSequenceContext *context)
{
    switch (step) {
        case 0: {
            ...
            return new TransmitStep(frame, context->getIfs(), false);
        }
        case 1:
            return nullptr;
        default:
...
IFrameSequenceStep *ManagementAckFs::prepareStep(FrameSequenceContext *context)
{
    switch (step) {
        case 0: {
            ...
            return new TransmitStep(mgmtFrame, context->getIfs(), false);
        }
        case 1: {
...
IFrameSequenceStep *BlockAckReqBlockAckFs::prepareStep(FrameSequenceContext *context)
{
    switch (step) {
        case 0: {
            ...
            return new TransmitStep(blockAckReq, context->getIfs(), true);
        }
        case 1: {
