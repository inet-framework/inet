...
//}
//
//void BasicStatistics::frameTransmissionSuccessful(const Ptr<Ieee80211DataOrMgmtHeader>& header, int retryCount)
//{
//    if (rateControl)
//        rateControl->frameTransmitted(frame, utils->getFrameMode(frame), retryCount, true, false);
//}
//
//void BasicStatistics::frameTransmissionUnsuccessful(const Ptr<Ieee80211DataOrMgmtHeader>& header, int retryCount)
//{
//    if (rateControl)
//        rateControl->frameTransmitted(frame, utils->getFrameMode(frame), retryCount, false, false);
//}
//
//void BasicStatistics::frameTransmissionUnsuccessfulGivingUp(const Ptr<Ieee80211DataOrMgmtHeader>& header, int retryCount)
//{
//    if (rateControl)
...
//}
//
//void BasicStatistics::frameTransmissionGivenUp(const Ptr<Ieee80211DataOrMgmtHeader>& header)
//{
//}
//
//void BasicStatistics::frameReceived(const Ptr<Ieee80211MacHeader>& header)
//{
