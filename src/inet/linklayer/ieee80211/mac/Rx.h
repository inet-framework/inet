...
class INET_API Rx : public cSimpleModule, public IRx
{
    ...
    protected:
        ...
        virtual bool isFcsOk(Packet *packet, const Ptr<Ieee80211MacHeader>& header) const;
    ...
    public:
        ...
        virtual bool lowerFrameReceived(Packet *packet, const Ptr<Ieee80211MacHeader>& header) override;
