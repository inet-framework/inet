...
class INET_API Rx : public cSimpleModule, public IRx
{
    ...
    protected:
        ...
        virtual bool isFcsOk(Packet *packet, const Ptr<Ieee80211Frame>& frame) const;
    ...
    public:
        ...
        virtual bool lowerFrameReceived(Packet *packet, const Ptr<Ieee80211Frame>& frame) override;
