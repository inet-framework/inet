...
class INET_API OriginatorQoSAckPolicy : public ModeSetListener, public IOriginatorQoSAckPolicy
{
    ...
    protected:
        ...
        virtual bool checkAgreementPolicy(const Ptr<Ieee80211DataHeader>& frame, OriginatorBlockAckAgreement *agreement) const;
    ...
    public:
        virtual bool isAckNeeded(const Ptr<Ieee80211MgmtHeader>& frame) const override;
        virtual AckPolicy computeAckPolicy(Packet *packet, const Ptr<Ieee80211DataHeader>& frame, OriginatorBlockAckAgreement *agreement) const override;
        virtual bool isBlockAckPolicyEligibleFrame(Packet *packet, const Ptr<Ieee80211DataHeader>& frame) const override;
        ...
        virtual simtime_t getAckTimeout(Packet *packet, const Ptr<Ieee80211DataOrMgmtHeader>& dataOrMgmtFrame) const override;
