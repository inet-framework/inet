...
class INET_API OriginatorQoSAckPolicy : public ModeSetListener, public IOriginatorQoSAckPolicy
{
    ...
    public:
        ...
        virtual AckPolicy computeAckPolicy(Packet *packet, const Ptr<Ieee80211DataHeader>& header, OriginatorBlockAckAgreement *agreement) const override;
        virtual bool isBlockAckPolicyEligibleFrame(Packet *packet, const Ptr<Ieee80211DataHeader>& header) const override;
        ...
        virtual simtime_t getAckTimeout(Packet *packet, const Ptr<Ieee80211DataOrMgmtHeader>& dataOrMgmtHeader) const override;
