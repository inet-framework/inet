...
// FIXME: implement!
bool TxopProcedure::isFinalFragment(const Ptr<Ieee80211MacHeader>& frame) const
{
    return false;
}

// FIXME: implement!
bool TxopProcedure::isTxopInitiator(const Ptr<Ieee80211MacHeader>& frame) const
{
    return false;
}

// FIXME: implement!
bool TxopProcedure::isTxopTerminator(const Ptr<Ieee80211MacHeader>& frame) const
{
    return false;
}
