 ...
 * (~Dcf/~Hcf) via the `frameTransmittedAirtime` signal (see ~Ieee80211TransmittedAirtime). The
 ...
 *
 * @see AirtimeFairnessQueue, AirtimeFairnessScheduler, Ieee80211TransmittedAirtime
 */
