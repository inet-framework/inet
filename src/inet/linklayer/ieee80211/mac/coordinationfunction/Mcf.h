...
class INET_API Mcf : public ICoordinationFunction, public cSimpleModule
{
    ...
    public:
        virtual void processUpperFrame(Packet *packet, const Ptr<Ieee80211DataOrMgmtHeader>& header) override { throw cRuntimeError("Unimplemented!"); }
        virtual void processLowerFrame(Packet *packet, const Ptr<Ieee80211MacHeader>& header) override { throw cRuntimeError("Unimplemented!"); };
