...
#ifndef __INET_EXAMPLEMACCLASSIFIER_H
#define __INET_EXAMPLEMACCLASSIFIER_H
 ...
 */
class INET_API ExampleMacQoSClassifier : public IMacQoSClassifier
{
  private:
    int defaultAC;
