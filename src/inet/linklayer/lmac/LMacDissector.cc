...
#include "inet/linklayer/lmac/LMacDissector.h"
...
Register_Protocol_Dissector(&Protocol::lmac, LMacDissector);

void LMacDissector::dissect(Packet *packet, ICallback& callback) const
{
