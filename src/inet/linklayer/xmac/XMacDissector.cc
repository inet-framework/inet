...
#include "inet/linklayer/xmac/XMacDissector.h"
...
Register_Protocol_Dissector(&Protocol::xmac, XMacDissector);

void XMacDissector::dissect(Packet *packet, ICallback& callback) const
{
