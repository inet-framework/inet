...
#include "inet/linklayer/shortcut/ShortcutMacDissector.h"
#include "inet/linklayer/shortcut/ShortcutMacHeader_m.h"

namespace inet {

Register_Protocol_Dissector(&Protocol::shortcutMac, ShortcutMacDissector);

void ShortcutMacDissector::dissect(Packet *packet, ICallback& callback) const
{
