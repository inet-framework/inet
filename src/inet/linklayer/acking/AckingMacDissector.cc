...
#include "inet/linklayer/acking/AckingMacDissector.h"
...
Register_Protocol_Dissector(&Protocol::ackingmac, AckingMacDissector);

void AckingMacDissector::dissect(Packet *packet, ICallback& callback) const
{
