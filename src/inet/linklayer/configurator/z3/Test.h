#ifndef __INET_Z3_TEST_H
#define __INET_Z3_TEST_H
  ...
  public:
	void runTestCase(){
		...
		*/
		...
		nodeList = new std::deque<PathNode *>();
		nodeList->push_back(pathNode0);
		nodeList->push_back(nodeList->front()->addChild(switch4));
        nodeList->pop_front();
		nodeList->push_back(nodeList->front()->addChild(switch3));
        nodeList->pop_front();
		nodeList->front()->addChild(dev15);
		nodeList->front()->addChild(dev16);
		nodeList->front()->addChild(dev17);
		nodeList->front()->addChild(dev18);
		nodeList->front()->addChild(dev19);
		nodeList->pop_front();
		...
		nodeList = new std::deque<PathNode *>();
		nodeList->push_back(pathNode1);
		nodeList->push_back(nodeList->front()->addChild(switch7));
        nodeList->pop_front();
		nodeList->push_back(nodeList->front()->addChild(switch6));
        nodeList->pop_front();
		nodeList->front()->addChild(dev30);
		nodeList->front()->addChild(dev31);
		nodeList->front()->addChild(dev32);
		nodeList->front()->addChild(dev33);
		nodeList->front()->addChild(dev34);
		nodeList->pop_front();
		...
		nodeList = new std::deque<PathNode *>();
		nodeList->push_back(pathNode2);
		nodeList->push_back(nodeList->front()->addChild(switch1));
		nodeList->pop_front();
		nodeList->push_back(nodeList->front()->addChild(switch2));
        nodeList->pop_front();
		nodeList->front()->addChild(dev10);
		nodeList->front()->addChild(dev11);
		nodeList->front()->addChild(dev12);
		nodeList->front()->addChild(dev13);
		nodeList->front()->addChild(dev14);
		nodeList->pop_front();
