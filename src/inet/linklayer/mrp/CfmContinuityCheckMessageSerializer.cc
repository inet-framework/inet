...
void CfmTlvSerializer::serializeFields(MemoryOutputStream& stream, const Ptr<const Chunk>& chunk) const
{
...
const Ptr<Chunk> CfmTlvSerializer::deserializeFields(MemoryInputStream& stream, const std::type_info&) const
{
