...
#ifndef __INET_ETHERMACFULLDUPLEXBASE_H
#define __INET_ETHERMACFULLDUPLEXBASE_H
...
class INET_API EtherMacFullDuplexBase : public MacProtocolBase
{
  ...
  public:
    EtherMacFullDuplexBase();
    virtual ~EtherMacFullDuplexBase();
...
#endif // ifndef __INET_ETHERMACFULLDUPLEXBASE_H
