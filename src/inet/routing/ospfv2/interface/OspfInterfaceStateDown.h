...
class INET_API InterfaceStateDown : public OspfInterfaceState
{
  public:
    virtual void processEvent(OspfInterface *intf, OspfInterface::OspfInterfaceEventType event) override;
    virtual OspfInterface::OspfInterfaceStateType getState() const override { return OspfInterface::DOWN_STATE; }
};
