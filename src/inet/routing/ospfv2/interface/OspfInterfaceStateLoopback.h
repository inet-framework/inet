...
class INET_API InterfaceStateLoopback : public OspfInterfaceState
{
  public:
    virtual void processEvent(OspfInterface *intf, OspfInterface::OspfInterfaceEventType event) override;
    virtual OspfInterface::OspfInterfaceStateType getState() const override { return OspfInterface::LOOPBACK_STATE; }
};
