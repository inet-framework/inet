...
class INET_API InterfaceStateNotDesignatedRouter : public OspfInterfaceState
{
  public:
    virtual void processEvent(OspfInterface *intf, OspfInterface::OspfInterfaceEventType event) override;
    virtual OspfInterface::OspfInterfaceStateType getState() const override { return OspfInterface::NOT_DESIGNATED_ROUTER_STATE; }
};
