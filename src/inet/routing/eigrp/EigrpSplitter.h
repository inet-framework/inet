...
class INET_API EigrpSplitter : protected cListener, public SimpleModule, public IPassivePacketSink
{
  protected:
    PassivePacketSinkRef ipOutSink;
    PassivePacketSinkRef splitterOutSink;
    PassivePacketSinkRef splitter6OutSink;
