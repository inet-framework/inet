...
DYMO_RoutingTable::DYMO_RoutingTable(DYMOFau* host, const L3Address& myAddr)
{
    // get our host module
 ...
 */
//=================================================================================================
DYMO_RoutingEntry* DYMO_RoutingTable::getByAddress(L3Address addr)
{
    for (auto iter = routeVector.begin(); iter < routeVector.end(); iter++)
    {
 ...
 */
//=================================================================================================
DYMO_RoutingEntry* DYMO_RoutingTable::getForAddress(L3Address addr)
{
    int longestPrefix = 0;
    ...
    for (auto iter = routeVector.begin(); iter < routeVector.end(); iter++)
    {
        ...
        if (!addr.toIpv4().prefixMatches(entry->routeAddress.toIpv4(), entry->routePrefix)) continue;
