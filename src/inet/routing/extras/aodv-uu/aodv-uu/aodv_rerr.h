...
Ptr<RERR> rerr_create(u_int8_t flags, struct in_addr dest_addr,
                  u_int32_t dest_seqno);
void rerr_add_udest(Ptr<RERR> &rerr,struct in_addr udest, u_int32_t udest_seqno);
void rerr_process(Ptr<RERR> rerr, int rerrlen,struct in_addr ip_src,
