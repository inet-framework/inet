...
void aodv_socket_send(Packet*, struct in_addr dst, int len,
                      u_int8_t ttl, struct dev_info *dev,double delay=-1);

void aodv_socket_send_delayed(Packet * aodv_msg, struct in_addr dst, int len,
                      u_int8_t ttl, struct dev_info *dev,double delay);
void aodv_socket_cleanup(void);
void aodv_socket_process_packet(Packet *, int len,
