...
void Batman::_hna_global_add(OrigNode *orig_node, const HnaElement *hna_element)
{
...
void Batman::hna_global_add(OrigNode *orig_node, const HnaElement *new_hna, int16_t new_hna_len)
{
    int i, num_elements;
    // clean buffer
 ...
 */
void Batman::hna_global_update(OrigNode *orig_node, const HnaElement *new_hna, int16_t new_hna_len, NeighNode *old_router)
{
    HnaGlobalEntry *hna_global_entry;
