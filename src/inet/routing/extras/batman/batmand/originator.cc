...
void Batman::update_orig(OrigNode *orig_node, const BatmanPacket* in, const L3Address &neigh, BatmanIf *if_incoming, const HnaElement *hna_recv_buff, int16_t hna_buff_len, uint8_t is_duplicate, const simtime_t &curr_time)
{
    GwNode *gw_node;
