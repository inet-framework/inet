...
bool PimSm::handleStartOperation(LifecycleOperation *operation, IDoneCallback *doneCallback)
{
...
bool PimSm::handleStopOperation(LifecycleOperation *operation, IDoneCallback *doneCallback)
{
