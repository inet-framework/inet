...
#ifndef INET_ROUTING_PIM_PIMPROTOCOLPRINTER_H_
#define INET_ROUTING_PIM_PIMPROTOCOLPRINTER_H_
...
class INET_API PimProtocolPrinter : public ProtocolPrinter
{
  public:
...
#endif /* INET_ROUTING_PIM_PIMPROTOCOLPRINTER_H_ */
