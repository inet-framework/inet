...
#include "inet/networklayer/rsvp_te/RsvpDissector.h"
...
Register_Protocol_Dissector(&Protocol::rsvp, RsvpDissector);

void RsvpDissector::dissect(Packet *packet, ICallback& callback) const
{
