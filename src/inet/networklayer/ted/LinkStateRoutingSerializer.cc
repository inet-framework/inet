...
//                                   read back as SIMTIME_ZERO. This field
...
//   ----- v2 additions (TE metric/administrative group/SRLGs) -----
...
//
// LinkStateRouting.cc computes the chunk length as B(4) + B(164) * recordCount,
// matching this serializer's actual byte output; the two must be kept in
// lockstep (RsvpTe.cc's compute*MessageLength() precedent: the serializer is
// the source of truth, the model's setChunkLength() call must match it).
// ===========================================================================
