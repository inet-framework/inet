...
{
    // Dual-stack (RFC 7552 Section 3.1): the FEC Element's Address Family selects IPv4
    // (1, a 4-byte prefix) or IPv6 (2, a 16-byte prefix); this is the ONLY on-wire
    // change RFC 7552 needs for this TLV.
