 ...
 */
        ...
        for (int j = 0; j < topo.getNumNodes(); j++) {
            ...
            InterfaceEntry *localIf = ift->findInterfaceByNodeOutputGateId(localGate->getId());
            ...
            InterfaceEntry *nextHopOnlinkIf = nextHopIft->findInterfaceByNodeInputGateId(remoteGate->getId());
