...
uint32_t Ipv4NetworkConfigurator::fuckyou(InterfaceInfo *compatibleInterface, uint32_t networkNetmask, uint32_t networkAddress, std::vector<uint32_t> &assignedInterfaceAddresses)
{
