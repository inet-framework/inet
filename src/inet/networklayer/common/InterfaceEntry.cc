...
#endif // ifdef WITH_IPv6
    if (isisdata)
        out << " " << ((InterfaceProtocolData *)isisdata)->STR_COMPAT(); // Khmm...
    if (trilldata)
        out << " " << ((InterfaceProtocolData *)trilldata)->STR_COMPAT(); // Khmm...
    if (ieee8021ddata)
        out << " " << ((InterfaceProtocolData *)ieee8021ddata)->STR_COMPAT(); // Khmm...
    return out.str();
}
...
#endif // ifdef WITH_GENERIC
    if (isisdata)
        out << " " << ((InterfaceProtocolData *)isisdata)->STR_COMPAT() << "\n"; // Khmm...
    if (trilldata)
        out << " " << ((InterfaceProtocolData *)trilldata)->STR_COMPAT() << "\n"; // Khmm...
    if (ieee8021ddata)
        out << " " << ((InterfaceProtocolData *)ieee8021ddata)->STR_COMPAT() << "\n"; // Khmm...
    return out.str();
}
