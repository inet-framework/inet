...
#include "inet/networklayer/ipv4modular/Ipv4RoutingDecision.h"
...
Define_Module(Ipv4RoutingDecision);

void Ipv4RoutingDecision::initialize(int stage)
{
...
void Ipv4RoutingDecision::pushPacket(Packet *packet, cGate *gate)
{
...
void Ipv4RoutingDecision::handleMessage(cMessage *message)
{
    auto packet = check_and_cast<Packet *>(message);
    pushPacket(packet, packet->getArrivalGate());
}

bool Ipv4RoutingDecision::canPushSomePacket(cGate *gate) const
{
    return true;
}

bool Ipv4RoutingDecision::canPushPacket(Packet *packet, cGate *gate) const
{
    return true;
}

void Ipv4RoutingDecision::pushPacketStart(Packet *packet, cGate *gate, bps datarate)
{
    throw cRuntimeError("Invalid operation");
}

void Ipv4RoutingDecision::pushPacketEnd(Packet *packet, cGate *gate)
{
    throw cRuntimeError("Invalid operation");
}

void Ipv4RoutingDecision::pushPacketProgress(Packet *packet, cGate *gate, bps datarate, b position, b extraProcessableLength)
{
    throw cRuntimeError("Invalid operation");
}

void Ipv4RoutingDecision::handleCanPushPacketChanged(cGate *gate)
{
...
void Ipv4RoutingDecision::handlePushPacketProcessed(Packet *packet, cGate *gate, bool successful)
{
