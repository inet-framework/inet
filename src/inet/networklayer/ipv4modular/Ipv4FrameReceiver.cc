...
#include "inet/networklayer/ipv4modular/Ipv4FrameReceiver.h"
...
Define_Module(Ipv4FrameReceiver);

void Ipv4FrameReceiver::initialize(int stage)
{
...
void Ipv4FrameReceiver::pushPacket(Packet *packet, cGate *gate)
{
    ...
    if (!Ipv4Header::verifyCrc(ipv4Header)) {
...
void Ipv4FrameReceiver::sendIcmpError(Packet *packet, IcmpType type, IcmpCode code)
{
