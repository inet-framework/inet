...
//
  ...
  protected:
     ...
     */
    void processType2RH(Packet *packet, IPv6Datagram *datagram, IPv6RoutingHeader *rh);
     ...
     */
    void processHoAOpt(Packet *packet, IPv6Datagram *datagram, HomeAddressOption *hoaOpt);
