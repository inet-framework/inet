...
#include "inet/networklayer/ipv4/IgmpDissector.h"
...
Register_Protocol_Dissector(&Protocol::igmp, IgmpDissector);

void IgmpDissector::dissect(Packet *packet, ICallback& callback) const
{
