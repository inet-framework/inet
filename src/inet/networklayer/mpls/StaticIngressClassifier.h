 ...
 *
 * Dual-stack: `dest` is a generic ~L3Address (IPv4 or IPv6, auto-detected
 * from the XML `dest` string), matched against the packet's native
 * destination address via ~L3Address::matches(), keyed off an integer
