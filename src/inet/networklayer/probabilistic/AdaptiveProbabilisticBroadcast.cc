...
void AdaptiveProbabilisticBroadcast::updateNeighMap(const ProbabilisticBroadcastHeader *m)
{
    ...
    if (it == neighMap.end()) {
        ...
        scheduleClockEvent(getClockTime() + timeInNeighboursTable, removeEvent);
