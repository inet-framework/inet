...
class INET_API PacketInfo
{
  ...
  public:
    PacketInfo() {}
    const L3Address& getLocalAddress() const { return localAddress; }
    void setLocalAddress(const L3Address &localAddress) { this->localAddress = localAddress; }
    const L3Address& getRemoteAddress() const { return remoteAddress; }
    void setRemoteAddress(const L3Address &remoteAddress) { this->remoteAddress = remoteAddress; }
