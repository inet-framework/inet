 ...
 * Ipv6 implementation.
 */
class INET_API Ipv6 : public SimpleModule, public NetfilterBase, public LifecycleUnsupported, public IIpv6, public INetworkProtocol, public IPassivePacketSink
{
  public:
    /**
