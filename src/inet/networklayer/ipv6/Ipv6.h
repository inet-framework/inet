 ...
 * Ipv6 implementation.
 */
class INET_API Ipv6 : public ClockUsingModuleBase, public NetfilterBase, public LifecycleUnsupported, public INetworkProtocol, public IProtocolRegistrationListener
{
  public:
    /**
