...
void IPv6ErrorHandling::handleMessage(cMessage *msg)
{
    ...
    switch (type) {
        case ICMPv6_DESTINATION_UNREACHABLE: {
            const auto& msg2 = dynamicPtrCast<const Icmpv6DestUnreachableMsg>(icmpv6Header);
        ...
        case ICMPv6_PACKET_TOO_BIG: {
            const auto& msg2 = dynamicPtrCast<const Icmpv6PacketTooBigMsg>(icmpv6Header);
            int code = msg2->getCode();
            int mtu = msg2->getMTU();
        ...
        case ICMPv6_TIME_EXCEEDED: {
            const auto& msg2 = dynamicPtrCast<const Icmpv6TimeExceededMsg>(icmpv6Header);
            int code = msg2->getCode();
            EV_ERROR << " Code: " << code;
        ...
        case ICMPv6_PARAMETER_PROBLEM: {
            const auto& msg2 = dynamicPtrCast<const Icmpv6ParamProblemMsg>(icmpv6Header);
            int code = msg2->getCode();
            EV_ERROR << " Code: " << code;
