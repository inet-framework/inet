...
#include "inet/emulation/linklayer/ieee80211/ExtIeee80211TapDeviceFileIo.h"
#include "inet/linklayer/ethernet/EtherEncap.h"
#include "inet/linklayer/ethernet/EtherFrame_m.h"

namespace inet {

Define_Module(ExtIeee80211TapDeviceFileIo);

ExtIeee80211TapDeviceFileIo::~ExtIeee80211TapDeviceFileIo()
{
    closeTap();
}

void ExtIeee80211TapDeviceFileIo::initialize(int stage)
{
...
void ExtIeee80211TapDeviceFileIo::handleMessage(cMessage *msg)
{
...
void ExtIeee80211TapDeviceFileIo::refreshDisplay() const
{
    char buf[180];
...
void ExtIeee80211TapDeviceFileIo::finish()
{
    EV_INFO << numSent << " packets sent, " << numReceived << " packets received.\n";
    closeTap();
}

void ExtIeee80211TapDeviceFileIo::openTap(std::string dev)
{
...
void ExtIeee80211TapDeviceFileIo::closeTap()
{
    NetworkNamespaceContext context(par("namespace"));
...
bool ExtIeee80211TapDeviceFileIo::notify(int fd)
{
    Enter_Method_Silent();
    ASSERT(fd == this->fd);
    uint8_t buffer[1 << 16];
