...
class INET_API SCTPSocket
{
  ...
  public:
    ...
    void setMaxInitRetrans(int option) { sOptions->maxInitRetrans = option; printf("initRetrans set to %d\n", sOptions->maxInitRetrans); };
    ...
    void connect(L3Address remoteAddress, int32 remotePort, uint32 numRequests, bool options);
