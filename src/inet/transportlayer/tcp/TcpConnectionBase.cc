...
simsignal_t TcpConnection::deliveredCeBytesSignal = registerSignal("deliveredCeBytes"); // AccECN (Workstream G7): cumulative CE byte count from AccECN option evidence only
