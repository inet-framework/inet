...
#include <omnetpp/cvsgscenenode.h>   // omnetpp::create3DSceneNode
...
void SceneVsgVisualizerBase::initializeScene()
{
    ...
    if (osgCanvas->getSceneNode() != nullptr)
        ...
        osgCanvas->setSceneNode(omnetpp::create3DSceneNode(topLevelScene));
