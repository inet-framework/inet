...
class INET_API PathOsgVisualizerBase : public PathVisualizerBase
{
  ...
  protected:
    ...
    virtual const PathVisualization *createPathVisualization(const std::vector<int>& path, cPacket *packet) const override { return PathVisualizerBase::createPathVisualization(path); }
    virtual void setAlpha(const PathVisualization *pathVisualization, double alpha) const override {}
