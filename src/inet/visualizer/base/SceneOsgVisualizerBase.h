...
class INET_API SceneOsgVisualizerBase : public SceneVisualizerBase
{
  ...
  protected:
    ...
    virtual void initializePlaygroundFloor();
    virtual osg::Geode *createPlaygroundFloor(const Coord& min, const Coord& max, cFigure::Color& color, osg::Image *image, double imageSize, double opacity, bool shading) const;
