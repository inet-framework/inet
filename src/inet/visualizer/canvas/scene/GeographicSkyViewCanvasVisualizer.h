...
#ifndef __INET_GEOGRAPHICSKYVIEWCANVASVISUALIZER_H
#define __INET_GEOGRAPHICSKYVIEWCANVASVISUALIZER_H
 ...
 * (typically a ground station using GeographicStationaryMobility), showing where
 ...
 * and the band below `minElevationAngle` is shown with a translucent mask. Each
 ...
 */
class INET_API GeographicSkyViewCanvasVisualizer : public VisualizerBase, public cListener
{
  protected:
