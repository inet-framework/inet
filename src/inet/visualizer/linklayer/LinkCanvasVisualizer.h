...
#ifndef __INET_LINKCANVASVISUALIZER_H
#define __INET_LINKCANVASVISUALIZER_H
...
class INET_API LinkCanvasVisualizer : public LinkVisualizerBase
{
  protected:
...
#endif // ifndef __INET_LINKCANVASVISUALIZER_H
