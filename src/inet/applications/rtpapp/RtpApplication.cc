...
void RtpApplication::initialize(int stage)
{
    ...
    if (stage == INITSTAGE_LOCAL) {
        ...
        scheduleClockEvent(getClockTime() + sessionEnterDelay, selfMsg);
    }
}
        ...
        switch (msgIn->getKind()) {
            ...
            case RTPAPP_START_TRANSMISSION:
                ...
                if (!isActiveSession) {
                    ...
                    scheduleClockEvent(getClockTime() + transmissionStopDelay, selfMsg);
                }
                break;
            ...
            switch (ci->getType()) {
                case RTP_IFP_SESSION_ENTERED: {
                    ...
                    if (opp_strcmp(fileName, "")) {
                        ...
                        scheduleClockEvent(getClockTime() + sessionLeaveDelay, selfMsg);
                    }
                }
                break;
                ...
                case RTP_IFP_SENDER_MODULE_CREATED: {
                    ...
                    scheduleClockEvent(getClockTime() + transmissionStartDelay, selfMsg);
                }
                break;
