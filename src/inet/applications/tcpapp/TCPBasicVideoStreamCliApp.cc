...
//#include "../../../../../TCPAdaptiveVideoUpdate/src/TCPBasicVideoStreamCliApp.h"
...
void TCPBasicVideoStreamCliApp::socketDataArrived(int connId, void *ptr, cPacket *msg, bool urgent) {
