...
void VoipStreamReceiver::pushPacket(Packet *packet, const cGate *gate)
{
...
cGate *VoipStreamReceiver::lookupModuleInterface(cGate *gate, const std::type_info& type, const cObject *arguments, int direction)
{
