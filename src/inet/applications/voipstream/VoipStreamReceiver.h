...
class INET_API VoipStreamReceiver : public SimpleModule, public LifecycleUnsupported, public UdpSocket::ICallback, public IPassivePacketSink, public IModuleInterfaceLookup
{
  public:
    VoipStreamReceiver() {}
    ~VoipStreamReceiver();
