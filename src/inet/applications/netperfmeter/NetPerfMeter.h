 ...
 */
class INET_API NetPerfMeter : public SimpleModule, public IPassivePacketSink, public IModuleInterfaceLookup, public UdpSocket::ICallback, public TcpSocket::ICallback, public SctpSocket::ICallback
{
  public:
    NetPerfMeter();
    ~NetPerfMeter();
