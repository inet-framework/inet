...
class INET_API PacketQueueBase : public PacketProcessorBase, public virtual IPacketQueue
{
  protected:
    ...
    std::vector<IPacketQueue::ICallback *> packetDropCallbacks;
  ...
  public:
    ...
    virtual void addPacketDropCallback(IPacketQueue::ICallback *callback) override;
    virtual void removePacketDropCallback(IPacketQueue::ICallback *callback) override;
