...
protected:
        ...
        */
        void processRequestMessage (Ptr<icancloud_Message > sm) override;

       /**
        * Process a response message.
        * @param sm Request message.
        */
        void processResponseMessage (Ptr<icancloud_Message> sm) override; 
...
public:
        ...
        */
        ...
        /*
         ...
         virtual void notifyManager(Packet *pkt) override;
