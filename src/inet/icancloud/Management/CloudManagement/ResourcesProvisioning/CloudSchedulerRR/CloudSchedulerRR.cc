...
void CloudSchedulerRR::initialize(int stage) {
...
vector<AbstractNode*> CloudSchedulerRR::selectStorageNodes (AbstractRequest* st_req){
    ...
    // Initialize ..
        ...
        if (streq == nullptr) throw cRuntimeError("CloudSchedulerRR::selectStorageNodes ->can not cast to storage request\n");
...
int CloudSchedulerRR::selectNodeSet (const string &setName, int vmcpu, int vmmemory){
