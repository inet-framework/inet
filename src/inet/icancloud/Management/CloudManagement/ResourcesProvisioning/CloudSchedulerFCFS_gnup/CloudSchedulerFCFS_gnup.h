...
/**
 * @class CloudSchedulerFSFC_gnup- CloudSchedulerFSFC_gnup.h CloudSchedulerFSFC_gnup.cc
 *
...
#ifndef SCHEDULER_FSFCGNUP_H_
#define SCHEDULER_FSFCGNUP_H_
...
class CloudSchedulerFCFS_gnup : public AbstractCloudScheduler{
	...
	protected:
		...
		int maximum_number_of_processes_per_node;
         ...
         //Flags To control the energy printing
             ...
             char log_name2[NAME_SIZE];
             char log_name3[NAME_SIZE];
             char log_name4[NAME_SIZE];
