...
#ifndef __INET_STREAMBUFFERCHUNKSERIALIZER_H
#define __INET_STREAMBUFFERCHUNKSERIALIZER_H

#include "inet/common/packet/serializer/ChunkSerializer.h"

namespace inet {

class INET_API StreamBufferChunkSerializer : public ChunkSerializer
{
  public:
