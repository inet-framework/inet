...
class INET_API cPointerResultFilter : public cResultFilter
{
    protected:
        ...
        virtual void receiveSignal(cResultFilter *prev, simtime_t_cref t, OMNETPP5_CODE(long) OMNETPP6_CODE(intval_t) l, cObject *details) override { }
        virtual void receiveSignal(cResultFilter *prev, simtime_t_cref t, OMNETPP5_CODE(unsigned long) OMNETPP6_CODE(uintval_t) l, cObject *details) override { }
...
class INET_API ElapsedTimeFilter : public cResultFilter
{
  ...
  protected:
    ...
    virtual void receiveSignal(cResultFilter *prev, simtime_t_cref t, OMNETPP5_CODE(long) OMNETPP6_CODE(intval_t) l, cObject *details) override {fire(this, t, getElapsedTime(), details);}
    virtual void receiveSignal(cResultFilter *prev, simtime_t_cref t, OMNETPP5_CODE(unsigned long) OMNETPP6_CODE(uintval_t) l, cObject *details) override {fire(this, t, getElapsedTime(), details);}
...
class INET_API LocalSignalFilter : public cObjectResultFilter
{
  ...
  public:
    ...
    virtual void receiveSignal(cComponent *source, simsignal_t signal, OMNETPP5_CODE(long) OMNETPP6_CODE(intval_t) l, cObject *details) override;
    virtual void receiveSignal(cComponent *source, simsignal_t signal, OMNETPP5_CODE(unsigned long) OMNETPP6_CODE(uintval_t) l, cObject *details) override;
