...
Define_InitStage(QUEUEING_CONFIGURATION);
Define_InitStage_Dependency(QUEUEING_CONFIGURATION, PHYSICAL_LAYER);
Define_InitStage(QUEUEING);
Define_InitStage_Dependency(QUEUEING, QUEUEING_CONFIGURATION);
