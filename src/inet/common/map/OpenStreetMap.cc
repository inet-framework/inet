...
StreetMap::StreetMap(StreetMap&& other)
{
    bounds = other.bounds;
...
void StreetMap::releaseAllocations()
{
...
void StreetMap::operator=(StreetMap&& other)
{
    if (this != &other) {
        releaseAllocations();
        bounds = other.bounds;
...
const char *StreetMap::getPooled(const char *s)
{
    if (s == nullptr)
        return nullptr;
...
void StreetMap::parseTags(cXMLElement *parent, Tags& tags)
{
...
StreetMap StreetMap::from(cXMLElement *mapRoot)
{
    StreetMap map;
