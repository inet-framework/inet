...
#include "inet//physicallayer/unitdisk/UnitDiskDissector.h"
...
Register_Protocol_Dissector(&Protocol::unitdisk, UnitDiskDissector);

void UnitDiskDissector::dissect(Packet *packet, ICallback& callback) const
{
