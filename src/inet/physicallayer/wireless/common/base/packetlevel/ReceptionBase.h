...
class INET_API ReceptionBase : public virtual IReception, public virtual IReceptionAnalogModel, public cObject
{
  protected:
    ...
    public: const INewReceptionAnalogModel *newAnalogModel = nullptr;
  ...
  public:
    ...
    virtual const INewReceptionAnalogModel *getNewAnalogModel() const override { return newAnalogModel; }
};
