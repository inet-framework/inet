...
class INET_API Ieee80211Receiver : public FlatReceiverBase, public IIeee80211ReceiverCapabilities
{
  protected:
  ...
  public:
    ...
    bool isHtChannelWidthSupported(Hz channelWidth) const override;
    bool isHtShortGuardIntervalSupported(Hz channelWidth) const override;
};
