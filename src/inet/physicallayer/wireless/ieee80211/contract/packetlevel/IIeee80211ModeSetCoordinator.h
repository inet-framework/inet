 ...
 * The coordinator updates MAC capabilities before MANAGEMENT_STATE and DERIVED_STATE;
 * consumers within DERIVED_STATE are independent. MAC_STATE is reserved for the owner.
...
{
  public:
    enum Phase { MAC_STATE, MANAGEMENT_STATE, DERIVED_STATE };
