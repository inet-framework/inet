...
#ifndef __INET_SHORTCUTPHYHEADERSERIALIZER_H
#define __INET_SHORTCUTPHYHEADERSERIALIZER_H
...
class INET_API ShortcutPhyHeaderSerializer : public ChunkSerializer
{
  public:
