...
DimensionalSignalAnalogModel::DimensionalSignalAnalogModel(const simtime_t duration, Hz carrierFrequency, Hz bandwidth, const math::Function<W, simtime_t, Hz> *power) :
...
DimensionalTransmissionSignalAnalogModel::DimensionalTransmissionSignalAnalogModel(const simtime_t duration, Hz carrierFrequency, Hz bandwidth, const math::Function<W, simtime_t, Hz> *power) :
    DimensionalSignalAnalogModel(duration, carrierFrequency, bandwidth, power)
{
}

DimensionalReceptionSignalAnalogModel::DimensionalReceptionSignalAnalogModel(const simtime_t duration, Hz carrierFrequency, Hz bandwidth, const math::Function<W, simtime_t, Hz> *power) :
    DimensionalSignalAnalogModel(duration, carrierFrequency, bandwidth, power)
{
}
