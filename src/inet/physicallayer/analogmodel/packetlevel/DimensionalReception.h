...
class INET_API DimensionalReception : public FlatReceptionBase
{
  ...
  public:
    DimensionalReception(const IRadio *radio, const ITransmission *transmission, const simtime_t startTime, const simtime_t endTime, const Coord startPosition, const Coord endPosition, const Quaternion startOrientation, const Quaternion endOrientation, Hz carrierFrequency, Hz bandwidth, const math::Function<W, simtime_t, Hz> *power);
    virtual ~DimensionalReception() { delete power; }

    virtual const math::Function<W, simtime_t, Hz> *getPower() const { return power; }
