 ...
 */
class INET_API StateBasedCcEnergyConsumer : public cSimpleModule, public virtual ICcEnergyConsumer, public cListener
{
  protected:
    // parameters
  ...
  public:
    ...
    virtual void receiveSignal(cComponent *source, simsignal_t signal, double value DETAILS_ARG) override;
};
