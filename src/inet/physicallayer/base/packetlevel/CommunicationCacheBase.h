...
class INET_API CommunicationCacheBase : public cModule, public ICommunicationCache
{
  ...
  public:
    ...
    virtual const IReceptionDecision *getCachedDecision(const IRadio *radio, const ITransmission *transmission) override;
    virtual void setCachedDecision(const IRadio *radio, const ITransmission *transmission, const IReceptionDecision *decision) override;
    virtual void removeCachedDecision(const IRadio *radio, const ITransmission *transmission) override;
