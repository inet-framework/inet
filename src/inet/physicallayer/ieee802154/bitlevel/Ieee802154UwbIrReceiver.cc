...
//        arg.setTime(now);
        ...
        const math::Function<W, simtime_t, Hz> *const signalPower = dimensionalSignalReception->getPower();
...
//            const math::Function<W, simtime_t, Hz> *const interferingPower = dimensionalInterferingReception->getPower();
