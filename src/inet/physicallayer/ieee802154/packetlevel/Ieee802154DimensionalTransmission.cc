...
std::ostream& Ieee802154DimensionalTransmission::printToStream(std::ostream& stream, int level) const
{
    stream << "Ieee802154DimensionalTransmission";
