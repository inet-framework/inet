...
#include "inet/physicallayer/shortcut/ShortcutPhyDissector.h"
#include "inet/physicallayer/shortcut/ShortcutPhyHeader_m.h"

namespace inet {

Register_Protocol_Dissector(&Protocol::shortcutPhy, ShortcutPhyDissector);

void ShortcutPhyDissector::dissect(Packet *packet, ICallback& callback) const
{
