...
bbn_transmitter_sptr bbn_make_transmitter(int spb, double alpha, double gain, bool use_barker=false);


class bbn_transmitter : virtual public gr::top_block {
  friend bbn_transmitter_sptr bbn_make_transmitter(int spb, double alpha, double gain, bool use_barker);

  bbn_transmitter(int spb, double alpha, double gain, bool use_barker);
