...
void JakesFading::initialize(int stage) {
    if (stage == INITSTAGE_LOCAL) {
        int fadingPaths = par("fadingPaths");
        double delayRMS = par("delayRMS");
...
double JakesFading::computePathLoss(mps propagationSpeed, Hz frequency, m distance) const
{
