...
#  define EV_FATAL_C(category)  EV << "FATAL: "
#  define EV_ERROR_C(category)  EV << "ERROR: "
#  define EV_WARN_C(category)   EV << "WARN: "
#  define EV_INFO_C(category)   EV
#  define EV_DETAIL_C(category) EV << "DETAIL: "
#  define EV_DEBUG_C(category)  EV << "DEBUG: "
#  define EV_TRACE_C(category)  EV << "TRACE: "
