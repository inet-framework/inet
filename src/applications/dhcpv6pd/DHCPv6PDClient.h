...
#ifndef INET_DHCPV6PDCLIENT_H__
#define INET_DHCPV6PDCLIENT_H__
...
/**
 * Implements a DHCPv6PD client. See NED file for more details.
 */
class INET_API DHCPv6PDClient : public cSimpleModule, public INotifiable, public ILifecycle
{
    protected:
        int serverPort;
        int clientPort;
        ...
        DHCPv6PDLease *lease; // leased IP information
        IPv6Route *route; // last added route
    ...
    protected:
         ...
         */
        virtual void handleDHCPMessage(DHCPv6PDMessage * msg);
         ...
         */
        virtual void sendDecline(IPv6Address declinedIp);

        /*
         * Records configuration parameters from a DHCPACK message.
         */
        virtual void recordLease(DHCPv6PDMessage * dhcpACK);

        /*
         * Records minimal configuration parameters from a DHCPOFFER message.
         */
        virtual void recordOffer(DHCPv6PDMessage * dhcpOffer);
         ...
         */
        virtual void handleDHCPACK(DHCPv6PDMessage * msg);
