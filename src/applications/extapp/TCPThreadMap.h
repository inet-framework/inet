...
class INET_API TCPThreadMap
{
  protected:
    typedef std::map<int,ITCPAppThread *> ThreadMap;
    ThreadMap threadMap;
  public:
    /**
     * Constructor.
